    ...
    class opcionesdb
    {
        ...
        public void InsertarATabla(String nomTabla, Hashtable crit)
        {
            ...
            catch (Exception ex)
            {
             //   RadMessageBox.SetThemeName("TelerikMetroBlue");
                MessageBox.Show("El Dato que trata de agregar ya  existe " + ex.Source);
            }
            finally
            {
        ...
        public void ModificarRegistro(String nomTabla, Hashtable crit, Hashtable reg)
        {
            try
            {
                ...
                {
                    MessageBox.Show("El registro  no ha sido modificado exitosamente");
                    con.desconectar();
                }
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("El registro  no ha sido modificado exitosamente" + ex.Message);
            }
            finally
            {
                con.desconectar();
